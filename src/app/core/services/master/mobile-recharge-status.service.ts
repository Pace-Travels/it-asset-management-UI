...
export class MobileRechargeStatusService {
  ...
  private readonly http = inject(HttpClient);
    ...
    getList(payload: any): Observable<any> {
        ...
        return this.http.get(
            `${this.controller}/master-Common-module/asset-information-category`,
            { params }
        );
    ...
    getByIdData(id: number): Observable<any> {
        ...
        return this.http.get(
            `${this.controller}/master-Common-module/asset-information-category/${id}`
        );
