...
export class VendorManagmentService {
  ...
  getList(payload: any): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/vendor-management`,
      { params }
    );
  ...
  add(payload: any): Observable<any> {
    ...
    return this.http.post(`${this.controller}/vendor-management/`, payload);
  ...
  getByIdData(id: number): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/vendor-management/${id}`
    );
