...
export class CloudSubscriptionServiceService {
  ...
  getList(payload: any): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/cloud-subs-service`,
      { params }
    );
  ...
  getByIdData(id: number): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/cloud-subs-service/${id}`
    );
