...
export class SubscriptionReminderType {
  ...
  getList(payload: any): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/subscription-reminder-type`,
      { params }
    );
  ...
  getByIdData(id: number): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/subscription-reminder-type/${id}`
    );
