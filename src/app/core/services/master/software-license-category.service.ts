...
export class SoftwareLicenseCategoryService {
  ...
  getList(payload: any): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/software-license-category`,
      { params }
    );
  ...
  getByIdData(id: number): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/software-license-category/${id}`
    );
