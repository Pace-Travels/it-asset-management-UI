...
export class EmailAccountStatusService {
  ...
  getList(payload: any): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/email-account-status`,
      { params }
    );
  ...
  getByIdData(id: number): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/email-account-status/${id}`
    );
