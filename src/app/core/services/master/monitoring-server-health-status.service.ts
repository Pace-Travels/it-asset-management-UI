...
export class MonitoringServerHealthStatusService {
  ...
  getList(payload: any): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/monitoring-backup-status`,
      { params }
    );
  ...
  getByIdData(id: number): Observable<any> {
    ...
    return this.http.get(
      `${this.controller}/master-Common-module/monitoring-backup-status/${id}`
    );
